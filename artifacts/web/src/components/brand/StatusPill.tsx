...
const TINTS: Record<WorkflowStatus, { bg: string; fg: string; dot: string }> = {
  ...
  "Changes Requested": {
    bg: "var(--ht-tint-orange)",
    fg: "#8A4F00",
    dot: "var(--ht-orange)",
  },
  "Manager Approved": {
    bg: "var(--ht-tint-green)",
    fg: "#34604F",
    dot: "var(--ht-light-green)",
  },
  "Finance Review": {
    bg: "var(--ht-tint-teal)",
    fg: "var(--ht-teal)",
    dot: "var(--ht-light-teal)",
  },
  "Finance Approved": {
    bg: "var(--ht-tint-green)",
    fg: "#2F6E55",
  ...
  Reconciled: {
    bg: "var(--ht-tint-success)",
    fg: "var(--ht-success)",
    dot: "var(--ht-success)",
  },
  Rejected: {
    bg: "var(--ht-tint-danger)",
    fg: "var(--ht-danger)",
    dot: "var(--ht-danger)",
  },
