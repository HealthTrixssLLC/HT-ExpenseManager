    ...
    return (
      <div style={{ width: "100%" }}>
            ...
            return (
              <div key={step} style={{ display: "flex", alignItems: "center", flex: 1 }}>
                ...
                >
                  ...
                  {active && (
                    <span
                      style={{ width: 8, height: 8, background: "white", borderRadius: 999 }}
                    />
                  )}
                  {paused && (
                    <span
        ...
        {offRamp && (
          ...
          >
            <span style={{ color: "var(--ht-ink-3)" }}>
              Off-ramp from {offRamp.fromStep}:
            </span>
      ...
      <span
        style={{
          ...
          border: `1px ${active ? "solid" : "dashed"} ${
            active ? tone.border : "var(--ht-border-strong)"
          }`,
        }}
      >
